...
With a 32-bit message sequenece number that (4 bn) mesaegs per day, you can have 31-bit cycles up to the year 5,881,421 though with hourly it runs out in the year 246,947. If you have more than 4 billion messages per cycle you can increase the number of bits used for cycles and thus the number of messages per cycle though reduce the number of cycles.
