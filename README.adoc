...
For named-tailer-position-based operational clean-up, see link:docs/roll-file-cleanup.adoc[Roll File Cleanup].
...
* https://github.com/OpenHFT/Chronicle-Queue/tree/develop/docs/roll-file-cleanup.adoc[Roll File Cleanup] - explains safe roll-file cleanup using named tailer positions
