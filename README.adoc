...
Chronicle Queue stores is data with an extension of 'cq4' in binary format,  like this :
...
'cq4'  files as text , can also help you fix your production issues, as it gives you visibility
of what has been   stored into the queue and in what order. 
