...
-  but in order to engage with our users, we are no-longer going to release to maven central, future releases are going to be moved onto our own chronicle nexus server, if you want access to this nexus server, to download the latest release artifacts, please contact sales@chronicle.software[mailto:sales@chronicle.software]
