...
Chronicle Software is a fast expanding company and we are offering a more commercially supported service to companies who use our libraries. Maven central is a fantastic location for downloading artifacts.  However, because our software is downloaded anonymously, it offers little opportunity for us to build a working relationship with your organisation.  Such an association would be beneficial to both parties. With our creative advice we can help your company get the most out of chronicle technology and also benefit from options you may not have considered.  We can save you both time and money. After much consideration, as to how we manage a balance with our existing user base and building up client contacts, we have decided to make the following changes:
...
-	In order to more closely engage with our users, we are no longer releasing to Maven Central. Future releases will be moved onto our own Chronicle nexus server. if you want access to this nexus server, to download the latest release artifacts, please contact sales@chronicle.software
