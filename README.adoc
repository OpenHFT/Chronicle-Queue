...
In this situation, we recommend either reading from these queues using Chronicle Queue v4 and writing back to new queue files using Chronicle Queue v5, or just treating Chronicle Queue files as Chronicle Wire data streams and reading the data sequentially via Chronicle Wire.
...
- Pretoucher
For improved outliers, see <<Pretoucher and its configuration>>
...
* https://github.com/OpenHFT/Chronicle-Queue/tree/develop/docs/encryption.adoc[Encryption] - describes how to encrypt the contents of a Queue
...
* https://github.com/OpenHFT/Chronicle-Queue/tree/develop/docs/timezone_rollover.adoc[Timezone rollover] - describes how to configure file-rolling at a specific time in a given time-zone
