...
If using MethodReaders and MethodWriters (xxxx link) then you can write single-argumnent method calls to a queue
...
If you want to write to the below method
