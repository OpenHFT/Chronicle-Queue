...
Say you have up to 1 trillion messages per day, you need 23-bit cycles allows for up to the year 24,936.

Note: by playing with the epoch, you can extend the dates further shifting the limit between the first and last cycle to 31-bits or 23-bits.
