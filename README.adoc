...
This section shows how to create a Pretoucher and configure its parameters.
The constructor of Pretoucher takes the name of the queue that this Pretoucher is assigned to and creates a new Pretoucher. Then, by invoking the `execute()` methode the Pretoucher starts.
[source,java]
----
