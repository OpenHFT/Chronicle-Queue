...
In case you are not yet interested in integrating Queue in one of your projects, you may want to start out by running one of our demos. You find our demonstrations link:https://github.com/OpenHFT/Chronicle-Queue-Demo[here^].
