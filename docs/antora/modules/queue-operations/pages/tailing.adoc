...
assertTrue(tailer.readBytes(b -> {
    long address = b.addressForRead(b.readPosition());
...
[source,text]
----
¡��@π�header∂�SCQStoreÇ™���ÕwritePositioné�����ç��������������������������������»indexing∂�SC
QSIndexingÇL��� indexCount•��ÃindexSpacing•��Àindex2Indexèß»�������…lastIndexé����ß�������� d
ataFormat°����
----
...
TIP: See xref:command-line:command_line_tools.adoc#_chroniclereadermain[] for the latest switch list, including the `-g` MessageHistory toggle introduced for MethodReader output.
