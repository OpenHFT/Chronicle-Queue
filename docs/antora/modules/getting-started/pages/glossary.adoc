...
* *Excerpt:* An excerpt is the part of the documents that Chronicle Queue writes that contains the actual data. When writing a message to a Chronicle Queue, a new xref:advanced:advanced.adoc#_queue_documents[document] (containing an excerpt) is created and written to.
