...
Anyone who wants to get a bit more inside into the data transefer between the remotes host of queue replication. This document is not a user functionally guide.
