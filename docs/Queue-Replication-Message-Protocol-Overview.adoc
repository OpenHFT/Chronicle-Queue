...
The SinkReplicationHandler uses a chronicle tailer to read new message from a chronicle queue, the contents of the chronicle queue is not inspected or parsed in any way its just sent as the replicaton event, also know as the `re` in the message below: 
```
--- !!meta-data #binary
cid: 292323922173575
 --- !!data #binary
