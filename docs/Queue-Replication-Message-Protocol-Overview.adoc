...
Anyone who wants to get a bit more inside into the data transfered between the remotes host for chronicle queue enterprise tcp/ip replication but this document is not a queue functionality document.
