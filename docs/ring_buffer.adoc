...
which can be used in your application code. https://jerryshea.github.io/2018/07/27/RingBuffer.html[This article]
gives some examples of how high-percentile latencies can be reduced.
...
created; when the underlying BytesStore is first written-to. The readers will live for as long as the ring buffer; until
you stop using the BytesStore.
