...
Chronicle Queue supports Linux container technology such as docker.

Our performance tests have shown that you can get excellent performance on the same physical host so long as
