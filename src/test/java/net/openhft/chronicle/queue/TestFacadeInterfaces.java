...
/**
 * Shared test facade interfaces used for testing Chronicle Values framework
 * with complex nested structures containing 164 value properties.
 * <p>
 * Used by both performance tests and JLBH benchmarks.
 */
@SuppressWarnings({"unused", "PMD.TestClassWithoutTestCases"})
public final class TestFacadeInterfaces {
    private TestFacadeInterfaces() {
        // utility class
    }
    ...
    public interface IFacadeSon extends IFacadeBase {
        long getValue19();
    ...
    public interface IFacadeDaughter extends IFacadeBase {
        long getValue33();
    ...
    public interface IFacade extends IFacadeBase {
        @Array(length = 3)
