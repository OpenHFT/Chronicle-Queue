...
public class EmptyRollCycleInMiddleTest extends QueueTestCommon {
    ...
    /**
     * Setup a queue with empty intermediate cycle files with missing EOF markers. The critical part of this 
     * issue reproduction is to have <strong>multiple</strong> empty queue files in the stream, not just one, 
     * all missing EOFs. In this case it seems that EOF markers are not added to the intermediate cycle files.
     */
    @Test
