    ...
    public void testCountExcerptsWhenTheCycleIsRolled() {
        ...
        try (final SingleChronicleQueue q = binary(name)
            ...
            String expectedEager = "--- !!meta-data #binary\n" +
                    ...
                    "]\n" +
                    "# position: 712, header: 0\n" +
                    "--- !!data\n" +
                    "1. some  text\n" +
                    "# position: 729, header: 1\n" +
                    "--- !!data\n" +
                    "2. some more text\n" +
                    "# position: 750, header: 2\n" +
                    "--- !!data\n" +
                    "3. some more text\n" +
                    "# position: 771, header: 2 EOF\n" +
                    "--- !!not-ready-meta-data! #binary\n" +
                    "...\n" +
                    "# 130297 bytes remaining\n" +
                    "--- !!meta-data #binary\n" +
                    "header: !SCQStore {\n" +
                    "  wireType: !WireType BINARY_LIGHT,\n" +
                    "  writePosition: [\n" +
                    ...
                    "# position: 743, header: 1\n" +
                    "--- !!data\n" +
                    "some more text\n" +
                    "...\n" +
                    "# 130307 bytes remaining\n";
