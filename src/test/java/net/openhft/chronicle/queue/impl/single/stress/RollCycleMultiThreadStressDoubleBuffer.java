...
public class RollCycleMultiThreadStressDoubleBuffer extends RollCycleMultiThreadStressTest {

    private AtomicBoolean queueDumped = new AtomicBoolean(false);

    public RollCycleMultiThreadStressDoubleBuffer() {
    ...
    public static void main(String[] args) throws Exception {
        new RollCycleMultiThreadStressDoubleBuffer().run();
    }
