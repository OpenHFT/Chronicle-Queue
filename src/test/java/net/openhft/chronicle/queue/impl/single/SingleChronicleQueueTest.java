    ...
    protected String expectedAppendAndReadWithRolling() {
        ...
        if (wireType == WireType.BINARY_LIGHT)
            return "--- !!meta-data #binary\n" +
                    ...
                    "--- !!data #binary\n" +
                    "test: 0\n" +
                    "# position: 618, header: 1\n" +
                    "--- !!data #binary\n" +
                    "test2: !short 1000\n" +
                    "# position: 631, header: 1 EOF\n" +
                    "--- !!not-ready-meta-data! #binary\n" +
                    "...\n" +
                    "# 130437 bytes remaining\n" +
                    "--- !!meta-data #binary\n" +
                    "header: !SCQStore {\n" +
                    "  wireType: !WireType BINARY_LIGHT,\n" +
                    "  writePosition: 618,\n" +
    ...
    protected String expectedMultipleAppenders() {
        ...
        if (wireType == WireType.BINARY_LIGHT)
            return "--- !!meta-data #binary\n" +
                    ...
                    "--- !!data\n" +
                    "hello B0\n" +
                    "# position: 632, header: 1\n" +
                    "--- !!meta-data #binary\n" +
                    "some meta 0\n" +
                    "# position: 648, header: 2\n" +
                    "--- !!data\n" +
                    "hello A1\n" +
                    "# position: 660, header: 3\n" +
                    "--- !!data\n" +
                    "hello B1\n" +
                    "# position: 672, header: 3\n" +
                    "--- !!meta-data #binary\n" +
                    "some meta 1\n" +
                    "# position: 688, header: 4\n" +
                    "--- !!data\n" +
                    "hello A2\n" +
                    "# position: 700, header: 5\n" +
                    "--- !!data\n" +
                    "hello B2\n" +
