...
public class SingleChronicleQueueTest extends ChronicleQueueTestBase {
    ...
    Bytes appenderListenerDump = Bytes.allocateElasticOnHeap(256);
    ...
    public void testAppend() {
        ...
        assertEquals("" +
                        ...
                        "\n" +
                        "idx: 4a0400000001\n" +
                        "# position: 788, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 1\n" +
                        "\n" +
                        "idx: 4a0400000002\n" +
                        "# position: 800, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 2\n" +
                        "\n" +
                        "idx: 4a0400000003\n" +
                        ...
                        "\n" +
                        "idx: 4a0400000004\n" +
                        "# position: 824, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 4\n" +
                        "\n" +
                        "idx: 4a0400000005\n" +
                        "# position: 836, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 5\n" +
                        "\n" +
                        "idx: 4a0400000006\n" +
                        ...
                        "\n" +
                        "idx: 4a0400000007\n" +
                        "# position: 860, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 7\n" +
                        "\n" +
                        "idx: 4a0400000008\n" +
                        "# position: 872, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 8\n" +
                        "\n" +
                        "idx: 4a0400000009\n" +
                        "# position: 884, header: 0\n" +
                        "--- !!data #binary\n" +
                        "test: 9\n" +
                        "\n",
    ...
    public void testMetaIndexTest() {
        ...
        assertEquals("" +
                        ...
                        "\n" +
                        "idx: 6f06c00000002\n" +
                        "# position: 65828, header: 0\n" +
                        "--- !!data #binary\n" +
                        "three\n" +
                        "\n" +
                        "idx: 6f06c00000003\n" +
                        "# position: 65864, header: 0\n" +
                        "--- !!data #binary\n" +
                        "four\n" +
                        "\n",
                appenderListenerDump.toString());
