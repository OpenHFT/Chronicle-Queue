...
public class InternalAppenderTest extends QueueTestCommon {
    ...
    public void replicationTest() throws Exception {
        ...
        try (final SingleChronicleQueue queue =
                     SingleChronicleQueueBuilder.single(file).testBlockSize().build();
            ...
            try (final SingleChronicleQueue app = SingleChronicleQueueBuilder.single(file).testBlockSize().build();
