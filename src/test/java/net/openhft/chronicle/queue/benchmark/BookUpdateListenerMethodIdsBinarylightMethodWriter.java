...
public final class BookUpdateListenerMethodIdsBinarylightMethodWriter implements BookUpdateListener, MethodWriter {
    ...
    // constructor
    public BookUpdateListenerMethodIdsBinarylightMethodWriter(Supplier<MarshallableOut> out, Closeable closeable, MethodWriterListener methodWriterListener, UpdateInterceptor updateInterceptor) {
        this.out = out;
