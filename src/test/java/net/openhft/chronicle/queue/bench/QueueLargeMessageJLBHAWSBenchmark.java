...
public class QueueLargeMessageJLBHAWSBenchmark implements JLBHTask {
    ...
    public static void main(String[] args) {
        ...
        CommandLine commandLine = CLIUtils.parseCommandLine(QueueLargeMessageJLBHAWSBenchmark.class.getSimpleName(), args, options);

        int iterations = CLIUtils.getIntOption(commandLine, 'i', 100_000);
        ...
        JLBHOptions lth = new JLBHOptions()
                ...
                .jlbhTask(new QueueLargeMessageJLBHAWSBenchmark());
