...
public class QueueTestCommon {
    ...
    public void recordExceptions() {
        ...
        for (String msg : "Forced unlock, Shrinking ,Allocation of , ms to add mapping for ,jar to the classpath, ms to pollDiskSpace for , us to linearScan by position from ,File released ,Overriding roll length from existing metadata, was 3600000, overriding to 86400000   ".split(",")) {
            ignoreException(msg);
        }
    }
