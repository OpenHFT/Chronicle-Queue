...
public class RollCycleDefaultingTest extends QueueTestCommon {
    ...
    @Test
    public void alias() {
        assertEquals(RollCycles.class, ObjectUtils.implementationToUse(RollCycle.class), "ObjectUtils.implementationToUse(RollCycle.class)");
    }
    ...
    public void correctConfigGetsLoaded() {
        ...
        assertEquals(HOURLY, builder.rollCycle(), "builder.rollCycle()");
    }
    ...
    public void customDefinitionGetsLoaded() {
        ...
        assertInstanceOf(MyRollcycle.class, builder.rollCycle(), "builder.rollCycle() instanceof MyRollcycle");
    }
    ...
    public void unknownClassDefaultsToDaily() {
        ...
        System.setProperty(QueueSystemProperties.DEFAULT_ROLL_CYCLE_PROPERTY, configuredCycle);
        SingleChronicleQueueBuilder builder = SingleChronicleQueueBuilder.binary(BASE_PATH);
        assertEquals(RollCycles.DEFAULT, builder.rollCycle(), "builder.rollCycle()");
