...
public class SingleChroniclePerfMainTest extends QueueTestCommon {
    ...
    @Test
    @DisplayName("Facade exposes a stable byte store view")
    public void testFacade() {
        ...
        assertEquals(bytesStore, byteable.bytesStore(), "Facade bytesStore should round-trip");
        assertEquals(0, byteable.offset(), "Facade offset should start at zero");
