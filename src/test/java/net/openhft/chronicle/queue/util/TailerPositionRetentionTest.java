 ...
 * advances it.
 */
public class TailerPositionRetentionTest extends QueueTestCommon {
    ...
    public void parkingADeadTailerResetsItToZeroAndStopsItPinning() throws Exception {
        ...
        try (SingleChronicleQueue q = builder(dir, time).build()) {
            ...
            assertTrue("pinned before parking", InternalTailerRetention.analyse(q, 2).lagWarning());
            assertTrue(InternalTailerRetention.analyse(q, 2).removable().isEmpty());
